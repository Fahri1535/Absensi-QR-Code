@extends('layouts.app')
@section('title','Data Karyawan & HRD')
@section('page-title','Data Karyawan & HRD')

@section('content')
<div class="page-header">
  <div class="breadcrumb">Beranda / <span>Data Karyawan &amp; HRD</span></div>
  <div style="display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:12px;">
    <h1>Data Karyawan &amp; HRD</h1>
