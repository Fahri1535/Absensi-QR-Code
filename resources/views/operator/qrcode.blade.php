...
<div class="page-header">
  ...
  <p class="text-muted">QR berisi tautan ke aplikasi agar bisa dipindai langsung dari menu <strong>Presensi QR</strong> di dalam aplikasi (Karyawan/HRD) atau melalui Google Lens. Pastikan <strong>APP_URL</strong> di file .env sesuai domain akses (mis. https://ngrok-anda.dev).</p>
</div>
...
<div class="responsive-grid stagger" style="margin-bottom:24px; gap:24px;">
  ...
  {{-- QR Code Pulang --}}
  <div class="card" style="border-left: 4px solid var(--green); background: linear-gradient(to right, rgba(0,224,150,0.05), transparent);">
    <div class="card-header">
