...
<div class="stat-grid stagger">
  ...
  <div class="stat-card">
    <div class="stat-icon" style="background:rgba(255,171,64,.12);color:#FFAB40;"><i class="fa-solid fa-file-medical"></i></div>
    <div class="stat-info">
      <div class="stat-label">Izin Pending</div>
      <div class="stat-value">{{ $izinPending ?? 0 }}</div>
      <div class="stat-delta" style="color:#FFAB40;">menunggu</div>
    </div>
  </div>
</div>
