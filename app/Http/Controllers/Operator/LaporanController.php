...
class LaporanController extends Controller
{
    public function index(Request $request)
    {
        ...
        $query = Presensi::with('karyawan.user')
        ...
        $laporan = $query->orderBy('tanggal')->orderBy('karyawan_id')->paginate(30)->withQueryString();

        // FIXED: $karyawanAll → $listKaryawan (sesuai view shared/laporan)
